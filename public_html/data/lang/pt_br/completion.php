...
$string['completiondefault'] = 'Rastreamento de conclusão padrão';
...
$string['coursecompletioncondition'] = 'Condição:';
...
$string['enablecompletion_help'] = 'Uma vez ativado, as configurações de rastreamento de conclusão são exibidas na página de acompanhamento da conclusão, e nas definições de atividade.';
...
$string['roleaggregation_all'] = 'Todas as funções são selecionadas para marcar quando a condição for atendida';
$string['roleaggregation_any'] = 'Todas as funções são selecionadas para marcar quando a condição for atendida';
$string['saved'] = 'Salvo';
