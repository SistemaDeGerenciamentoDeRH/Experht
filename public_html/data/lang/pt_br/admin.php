...
$string['configcourseoverviewfilesext'] = 'Lista das extensões de arquivos permitidos na visão geral do curso separados por vírgula.';
$string['configcourseoverviewfileslimit'] = 'Limitar o número de arquivos que os gerentes de curso são permitidos a adicionar no curso. Eles estarão acessíveis por qualquer usuário fora do curso tal como o nome do curso e/ou resumo.';
...
$string['debugstringids_desc'] = 'Esta opção foi projetada para ajudar os tradutores. Quando esta opção é habilitada, se você colocar o parâmetro = 1 para uma requisição de URL , ele irá mostrar o arquivo de idioma e ID do string ao lado de cada string de saída.';
...
$string['execpathnotallowed'] = 'Definindo caminhos executáveis com deficiência em config.php';
...
$string['modeditingmenu'] = 'Menus de edição';
...
$string['navshowfullcoursenames_help'] = 'Se habilitado, o nome dos cursos será exibido por completo ao invés do nome curto.';
...
$string['registration_help'] = 'Recomenda-se a registrar em Moodle.org receber alertas de e-mail de segurança, contribuir para o crescimento do Moodle e as estatísticas, ou para ser capaz de compartilhar cursos sobre MOOCH.';
...
$string['updateavailableforplugin'] = 'Há uma novas versões para alguns dos seus plugins disponíveis!';
...
$string['updatenotificationfooter'] = 'Seu site Moodle {$a->siteurl} está configurada para verificar automaticamente por atualizações disponíveis. Você está recebendo esta mensagem como administrador desse site. Você pode desabilitar as verificações automáticas por atualizações disponíveis na administração do site. Você pode customizar o envio desta mensagem na seção de configuração do seu perfil.';
...
$string['upgradepluginsinfo_help'] = 'Há atualizações disponíveis para alguns de seus plugins. O Moodle não os atualiza automaticamente ainda. Você tereá que baixar e instala-los manualmente.';
