...
$string['bbbinprocess'] = 'Esta atividade está em processo.';
$string['bbbnorecordings'] = 'Não há nenhuma gravação ainda, por favor, volte mais tarde.';
...
$string['bbburl'] = 'A URL de seu servidor BigBlueButton deve terminar com /bigbluebutton/. (Esta URL padrão é para um servidor BigBlueButton provida pela Blindside Networks e que você pode usá-la para testes.)';
$string['bigbluebuttonbn'] = 'BigBlueButton';
$string['bigbluebuttonbn:addinstance'] = 'Adicionar uma nova reunião';
$string['bigbluebuttonbnfieldset'] = 'Exemplo de campos personalizados';
...
$string['bigbluebuttonbnSalt'] = 'Sal de Segurança';
$string['bigbluebuttonbnUrl'] = 'URL do Servidor BigBlueButton';
$string['bigbluebuttonbnWait'] = 'O usuário tem que esperar';
...
$string['index_warning_adding_meeting'] = 'Incapaz de atribuir um novo ID da reunião.';
...
$string['mod_form_field_allmoderators'] = 'Permitir que todos os participantes sejam moderadores';
$string['mod_form_field_availabledate'] = '';
...
$string['mod_form_field_limitusers_help'] = 'O limite máximo de usuários permitidos em uma reunião';
