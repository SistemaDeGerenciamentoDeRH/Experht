...
$string['emailteachermail'] = '{$a->username} enviou a atividade: \'{$a->apply}\' Você pode vê-la aqui: {$a->url}';
$string['emailteachermailhtml'] = '{$a->username} enviou a atividade: <i>\'{$a->apply}\'</i> <br /><br /> Você pode vê-la <a href="{$a->url}">aqui</a> .';
