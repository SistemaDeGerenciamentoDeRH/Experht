...
$string['cannotaddsubscriber'] = 'Não foi possível adicionar subscritor com identificação {$a} a este fórum!';
...
$string['invalidforcesubscribe'] = 'Modo de subscrição forçada inválida';
...
$string['noonecansubscribenow'] = 'As subscrições não estão permitidas neste momento.';
...
$string['subscriptionmode_help'] = '<P>Um asssinante é um usuário que recebe cópias de todas as mensagens de um fórum via email.
Estas mensagens são enviadas via email minutos após a redação no fórum.</p>
...
$string['unsubscribealldone'] = 'Todas as suas subscrições foram removidas, mas você ainda pode receber notificações de fóruns configurados com subscrição obrigatória. Se você não deseja receber qualquer e-mail deste site, por favor altere seu perfil desativando seu endereço de e-mail.';
