...
$string['course:viewsuspendedusers'] = 'Pode ver os usuários suspensos.';
...
$string['customrolename_help'] = 'Nomes de funções padrão são localizados automaticamente se o nome personalizado está vazio. Você deve fornecer um nome completo para todas as funções personalizadas.';
...
$string['eventroleallowassignupdated'] = 'Permitir atribuição de função';
$string['eventroleallowoverrideupdated'] = 'Permitir sobreposição de papel';
$string['eventroleallowswitchupdated'] = 'Permitir troca de função';
...
$string['roleshortname_help'] = 'Nome da função é um identificador curto papel de baixo nível em que apenas caracteres alfanuméricos ASCII são permitidos. Não altere os nomes curtos de papéis padrão.';
