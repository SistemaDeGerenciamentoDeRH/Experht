...
$string['detectedmisplacedplugin'] = 'O plugin "{$a->component}" está equivocadamente instalado em "{$a->current}", O local correto é "{$a->expected}"';
$string['displayname'] = 'Nome do plugin';
$string['err_response_curl'] = 'Não foi possível obter dados disponíveis atualizações -  erro cURL inesperado.';
...
$string['err_response_http_code'] = 'Não foi possível obter dados disponíveis atualizações - código de resposta HTTP inesperado.';
...
$string['nonehighlighted'] = 'Não plugins requerem sua atenção agora';
...
$string['type_mod_plural'] = 'Módulos de atividades';
