...
$string['showonlyactiveenrol'] = 'Mostrar apenas as matrículas ativas';
$string['showonlyactiveenrol_help'] = 'Esta definição determina, se apenas os usuários inscritos ativos será visível no relatório diário de classe. Se os usuários suspensos habilitados não serão mostradas em livro de notas.';
