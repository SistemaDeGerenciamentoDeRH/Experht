...
$string['mail_content1'] = 'Um de seus laboratórios remotos anteriormente em operação (';
$string['mail_content2'] = '- IP:';
$string['mail_content3'] = ') deixou de ser acessível.';
...
$string['selectUsers_pageTitle'] = 'Seleção de usuários';
