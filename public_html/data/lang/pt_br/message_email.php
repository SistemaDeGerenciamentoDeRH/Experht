...
$string['configallowattachments'] = 'Abilitando esse recurso, será permitido o envio de anexos pelas mensagens de e-mail por vários recursos do site, como blogs, fórums ou badges(emblemas).';
